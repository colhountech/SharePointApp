...
namespace ConsoleAuthenticationManager
{
    public class AuthenticationManager : IDisposable
    {
        ...
        public AuthenticationManager(string tenantID, string defaultAADAppId)
        {
            this.tenantID = tenantID;
            this.defaultAADAppId = defaultAADAppId;
        }
        ...
        private async Task<string> AcquireTokenAsync(Uri resourceUri, string username, string password)
        {
            ...
            using (var stringContent = new StringContent(body, Encoding.UTF8, "application/x-www-form-urlencoded"))
            {
                ...
                {
                    Console.WriteLine("Did you Grant Admin Consent?");
                    var consentPrompt = $"https://login.microsoftonline.com/{tenantID}/adminconsent?client_id={clientId}";
                    Console.WriteLine(consentPrompt);
        ...
        public static SecureString GetSecureString(string promptUser)
        {
